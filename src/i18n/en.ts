...
const en: typeof ko = {
  ...
  evaluate: {
    ...
    limit: {
      ...
      aiErrorDesc: 'Something went wrong during AI evaluation. Please try again in a moment.',
    },
    result: {
      ...
      afterGenerateCta: 'Generate Improved Image',
      afterGenerating: 'Generating your image... (can take up to a minute)',
      afterRegenerateCta: 'Regenerate',
      afterProNote: 'Pro unlocks a real AI-generated image with your feedback applied.',
      afterProCta: 'Upgrade to Pro',
      afterErrorNote: 'Image generation failed. Please try again in a moment.',
